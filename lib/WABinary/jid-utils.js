...
const jidNormalizedUser = (jid) => {
    ...
    const { user, server, device, agent, isLid } = result;

    // Fix: preserve 'lid' encoding
    return (0, exports.jidEncode)(user, server === 'c.us' ? 's.whatsapp.net' : server, device, agent, isLid);
};
